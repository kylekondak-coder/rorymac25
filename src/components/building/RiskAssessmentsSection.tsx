              ...
              <div className="mt-3 pl-1 border-l-2 border-green-100">
                ...
                <div className="flex flex-col gap-2 mb-2">
                  {ra.actions.map((action) => {
                    ...
                    return (
                      <div
                        key={action.id}
                        className="flex items-center gap-3 text-sm bg-paper rounded px-3 py-2"
                      >
                        <span
                        ...
                        <span className={`flex-1 ${action.status === "closed" ? "line-through text-ink-soft" : ""}`}>
                          {action.description}
                        </span>
                        <form action={toggle}>
                ...
                <form action={addAction} className="flex flex-wrap items-end gap-2">
                  <input
                    ...
                    required
                  />
                  <select className="field-input w-auto" name="priority" defaultValue="medium">
